{% macro synth_geo_region(name, distribution="weighted", weight_col="population", filter="") -%}
    {{ return(synth_column_geo_region_type(name, "name", distribution, weight_col, filter)) }}
{%- endmacro %}

{% macro synth_geo_region_abbr(name, distribution="weighted", weight_col="population", filter="") -%}
    {{ return(synth_column_geo_region_type(name, "abbr", distribution, weight_col, filter)) }}
{%- endmacro %}
