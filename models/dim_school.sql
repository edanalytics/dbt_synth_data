...
{{ dbt_synth.table(
    ...
    columns = [
        ...
        dbt_synth.column_address(name='street_address', countries=['United States'], geo_region_abbrs=[var('state_code')], address_types=['house'], parts=['street_address']),
        dbt_synth.column_address(name='city', countries=['United States'], geo_region_abbrs=[var('state_code')], address_types=['house'], parts=['city'], distribution="uniform"),
        dbt_synth.column_value(name='name_of_county', value=None),
        dbt_synth.column_address(name='state_code', countries=['United States'], geo_region_abbrs=[var('state_code')], address_types=['house'], parts=['geo_region_abbr'], distribution="uniform"),
        dbt_synth.column_address(name='postal_code', countries=['United States'], geo_region_abbrs=[var('state_code')], address_types=['house'], parts=['postal_code']),
